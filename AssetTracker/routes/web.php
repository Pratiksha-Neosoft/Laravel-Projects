...
Route::view('add','admin.createtype');
Route::get('assetlist',[Myadmin::class,'showasset'])->middleware('noasset');
...
Route::view('datatables','admin.datatable');
Route::view('nochart','admin.nochart');
Route::view('noassetdata','admin.noassetdata');